...
public abstract class AbstractInterfaceConfig extends AbstractMethodConfig {
    ...
    protected void checkRegistry() {
        ...
        if ((registries == null || registries.size() == 0)) {
            throw new IllegalStateException((getClass().getSimpleName().startsWith("Reference") ? "No such any " +
                    "registry to refer service in consumer " : "No such any registry to export service in provider ")
                    + NetUtils.getLocalHost() + " use dubbo version " + Version.getVersion() + ", Please add " +
                    "<dubbo:registry address=\"...\" /> to your spring config. If you want unregister, please set " +
    ...
    protected URL loadMonitor(URL registryURL) {
        if (monitor == null) {
            ...
            if (monitorAddress != null && monitorAddress.length() > 0 || monitorProtocol != null && monitorProtocol
                    .length() > 0) {
