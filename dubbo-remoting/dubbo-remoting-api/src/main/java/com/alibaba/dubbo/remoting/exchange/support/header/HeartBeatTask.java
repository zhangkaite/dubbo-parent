        ...
        try {
            ...
            for (Channel channel : channelProvider.getChannels()) {
                ...
                try {
                    ...
                    if ((lastRead != null && now - lastRead > heartbeat) || (lastWrite != null && now - lastWrite >
                            heartbeat)) {
                        ...
                        if (logger.isDebugEnabled()) {
                            logger.debug("Send heartbeat to remote channel " + channel.getRemoteAddress() + ", cause:" +
                                    " The channel has no data-transmission exceeds a heartbeat period: " + heartbeat
                                    + "ms");
                        }
                    }
